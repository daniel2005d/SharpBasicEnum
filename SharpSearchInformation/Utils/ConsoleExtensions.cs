...
namespace SharpSearchInformation.Utils
{
...
#endif
    {
        ...
        public static string Pastel(this string input, int red, int green, int blue)
        {
            return _colorFormatFuncs[_enabled][ColorPlane.Foreground](input, Color.FromArgb(red, green, blue));
        }
